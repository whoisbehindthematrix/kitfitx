...
exports.scanFood = (0, error_js_1.TryCatch)(async (req, res) => {
    const file = req.file;
    const { prompt } = req.body;
    if (!file) {
        throw new errorHandler_js_1.default("No image uploaded", 400);
    }
    if (!process.env.GEMINI_API_KEY) {
        throw new errorHandler_js_1.default("Gemini API not configured", 500);
    }
    ...
    if (!output) {
        throw new errorHandler_js_1.default("Gemini response empty", 502);
    }
    ...
    try {
        ...
        throw new errorHandler_js_1.default("Gemini did not return valid JSON", 502);
    }
